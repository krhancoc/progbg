...
Currently users can choose between two generals styles: hatch or color
...
_color_styles = dict(
    a = [ "#762a83", "#af8dc3", "#e7d4e8", "#d9f0d3", "#7fbf7b", "#1b7837" ], # Colorblind + Printer Friendly
    b = [ "#a6cee3", "#1f78b4", "#b2df8a", "#33a02c", "#fb9a99", "#e31a1c" ], # Printer Friendly
    c = [ "#1b9e77", "#d95f02", "#7570b3", "#e7298a", "#66a61e", "#e6ab02" ], # Printer Friendly
)

_hatch_styles = dict(
    a = ["**", "++", "//", "xx", "oo"], # Colorblind + Printer Friendly
)
...
def get_style(style_name:str):
    ...
    Args:
        style_name (str): String in form "T_C" where T = color or hatch, and C = character (a-z)
